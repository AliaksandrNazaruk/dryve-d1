"""CiA402Drive facade — async API for CiA 402 drive over Modbus TCP Gateway.
...
CiA402Drive itself owns lifecycle (connect/close), telemetry integration,
...
_LOGGER_MODBUS = logging.getLogger("cia402.modbus")
_LOGGER = logging.getLogger(__name__)


@dataclass(frozen=True, slots=True)
class CiA402DriveConfig:
    """High-level configuration for the CiA402Drive facade."""
...
class CiA402Drive(
    ...
    """Async facade for CiA 402 drive over Modbus TCP Gateway.
    ...
    def __init__(self, *, config: CiA402DriveConfig) -> None:
        if config is None:
    ...
    async def _validate_connection(self) -> None:
        ...
        try:
            ...
            if min_pos >= max_pos:
                ...
                # software limits from CiA402DriveConfig still guard motion.
                _LOGGER.warning(

"""Configuration models for the CiA 402 drive driver."""
...
class MotionLimits(BaseModel):
    """Soft limits and validation rules used by the CiA402Drive facade.
    ...
    min_position_limit: int | None = Field(default=None)     # ODIndex.MIN_POSITION_LIMIT (0x607B)
    max_position_limit: int | None = Field(default=None)    # ODIndex.MAX_POSITION_LIMIT (0x607D)

...
class TelegramValidationError(ProtocolError):
    """Telegram violates CiA 402 drive gateway constraints (Byte 5/18 rules, reserved bytes, etc.)."""
...
class ModbusExceptionCode(IntEnum):
    """Modbus exception codes used by the CiA 402 drive gateway."""
...
class ModbusGatewayException(ProtocolError):
    ...
    For CiA 402 drive Modbus TCP Gateway:

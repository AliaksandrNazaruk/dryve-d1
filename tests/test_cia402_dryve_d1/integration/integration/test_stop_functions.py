...
async def test_stop_in_profile_position_mode(
    ...
    from dryve_d1.od.controlword import cw_enable_operation, cw_pulse_new_set_point
...
async def test_stop_in_profile_velocity_mode(
    ...
    from dryve_d1.motion.profile_velocity import ProfileVelocity, ProfileVelocityConfig

...
from cia402.cia402.state_machine import (
    CiA402StateMachine,
    StateMachineConfig,
)
from cia402.od.statusword import CiA402State
...
async def test_timeout_on_stuck_state():
    ...
    from cia402.cia402.state_machine import StateMachineError as SMError
